...
import (
	...
	"github.com/hy9be/gocloud/internal/testing/terraform"
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				dialerName: "github.com/hy9be/gocloud/mysql/gcpmysql/1",
			},
			want: func() *drvr.Config {
				cfg := drvr.NewConfig()
				cfg.AllowNativePasswords = true
				cfg.Net = "github.com/hy9be/gocloud/mysql/gcpmysql/1"
